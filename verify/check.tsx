...
const indices = ((s, e): void => {
	let step = e > s ? 1 : -1
	const _RET = Array.from({ length: Math.abs(e - s) }, (_, i): void => s + i * step)
})(0, array.length)
...
const getX = (civet: Civet, dir: Dir): void => {
	switch (dir) {
		case ">":
